...
elseif (DEFINED ENV{BUILDROOT})
    set(BUILDROOT "$ENV{BUILDROOT}/buildroot/arch64-rockchip-linux-gnu_sdk-buildroot")
else ()
    message("warning: XMX_BUILDROOT / BUILDROOT environment variable missing - using ~/buildroot/arch64-rockchip-linux-gnu_sdk-buildroot")
    set(BUILDROOT "$ENV{HOME}/buildroot/arch64-rockchip-linux-gnu_sdk-buildroot")
endif ()
